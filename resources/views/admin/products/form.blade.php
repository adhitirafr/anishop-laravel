                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <div class="form-group">
                            ...
                            {!! General::selectMultiLevel('category_ids', $categories, ['class' => 'form-control', 'multiple' => false, 'selected' => !empty(old('category_ids')) ? old('category_ids') : $categoryIDs, 'placeholder' => '-- Choose Category --']) !!}
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('height', null, ['class' => 'form-control', 'placeholder' => 'width']) !!}
                        </div>
